...
namespace QuanLy
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //var connectionString = Configuration.GetConnectionString("QLVBConnectionString");
            //services.AddDbContext<QuanLyVanBanContext>(item => item.UseSqlServer("connectionStrings"));
        }
