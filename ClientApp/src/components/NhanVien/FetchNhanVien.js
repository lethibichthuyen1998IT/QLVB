...
class FetchNhanVien extends React.Component {
                                        ...
                                        <ModalBody>
                                            <Form>
                                                ...
                                                <FormGroup>
                                                    ...
                                                    <Input id="hoten" value={this.state.newnv.Hoten} onChange={(e) => {
                                                        let { newnv } = this.state;
